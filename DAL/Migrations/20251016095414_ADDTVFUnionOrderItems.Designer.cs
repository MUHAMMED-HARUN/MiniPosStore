...
namespace DAL.Migrations
{
    ...
    [Migration("20251016095414_ADDTVFUnionOrderItems")]
    partial class ADDTVFUnionOrderItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e6047e9f-4ae0-414c-b936-05b52a768d03",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "7d1bbaf0-f1e4-4a28-84c7-a5ed346e55d3",
                            RoleId = "e6047e9f-4ae0-414c-b936-05b52a768d03"
                        });
                });
            ...
            modelBuilder.Entity("SharedModels.EF.Models.clsImportOrder", b =>
                {
                    ...
                    b.Property<int?>("clsRawMaterialID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SharedModels.EF.Models.clsUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7d1bbaf0-f1e4-4a28-84c7-a5ed346e55d3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1cfc0111-eb2a-4548-94ae-e76470de57b1",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEMNeeW50ftZRRLPaUhJ3IsFUC/6iGHjgjjsma0VuyMKyK4NZEZysrpeUtiml4wqMOg==",
                            Permissions = 0,
                            PersonID = 1,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d3e10e3e-44a3-4cf3-b300-8e5c314f86b8",
            ...
            modelBuilder.Entity("SharedModels.EF.Models.clsImportOrder", b =>
                {
                    ...
                    b.HasOne("SharedModels.EF.Models.clsRawMaterial", null)
                        .WithMany("ImportedRawMaterial")
                        .HasForeignKey("clsRawMaterialID");
            ...
            modelBuilder.Entity("SharedModels.EF.Models.clsRawMaterial", b =>
                {
                    b.Navigation("ImportedRawMaterial");
