...
{
    /// <inheritdoc />
    public partial class dfghdf : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Seymbol = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActoinByUser = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ActionType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Version = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogRegisters", x => x.ID);
                    table.ForeignKey(
                        name: "FK_LogRegisters_AspNetUsers_ActoinByUser",
                        column: x => x.ActoinByUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionByUser = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_ActionByUser",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ActionByUser",
                        column: x => x.ActionByUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionType = table.Column<byte>(type: "tinyint", nullable: false),
                    ActionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    clsProductID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportOrders", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ImportOrders_AspNetUsers_ActionByUser",
                        column: x => x.ActionByUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ImportOrders_Products_clsProductID",
                        column: x => x.clsProductID,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "6ceee3dc-1827-44c3-847c-e73ee8247613", null, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "People",
                columns: new[] { "ID", "FirstName", "LastName", "PhoneNumber" },
                values: new object[] { 1, "TestFirstName", "TestLastName", "12345678901" });

            migrationBuilder.InsertData(
                table: "UnitOfMeasures",
                columns: new[] { "ID", "Name", "Seymbol" },
                values: new object[,]
                {
                    { 1, "قطعة", "قطعة" },
                    { 2, "كيلوغرام", "كجم" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "58a85ef6-a3c7-4a19-beb8-5c179ab0b39b", 0, "2a0d9d81-748b-4bbb-b4bc-00a87266e0ce", "admin@example.com", true, false, null, "ADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEKMqKOphRNzrk5nEtLuXve8m2LvPUhZZa1zuS1IthukNDTLxbuY6oniJzgXYIoqFVQ==", 0, 1, null, false, "db03e989-99f6-405f-9717-def7250603d7", false, "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "6ceee3dc-1827-44c3-847c-e73ee8247613", "58a85ef6-a3c7-4a19-beb8-5c179ab0b39b" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportOrders_ActionByUser",
                table: "ImportOrders",
                column: "ActionByUser");

            migrationBuilder.CreateIndex(
                name: "IX_ImportOrders_clsProductID",
                table: "ImportOrders",
                column: "clsProductID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogRegisters_ActoinByUser",
                table: "LogRegisters",
                column: "ActoinByUser");
            ...
            clsTVFMigration.AddGetTopProductsID(migrationBuilder);
            clsTVFMigration.AddGetTopProductsFilter(migrationBuilder);
