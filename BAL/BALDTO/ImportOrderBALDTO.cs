...
namespace BAL.BALDTO
{
    public class ImportOrderBALDTO : ImportOrderDTO
    {
        ...
        public string FormattedTotalAmount => $"{TotalAmount:N2} {GetCurrencySymbol()}";
        public string FormattedPaidAmount => $"{PaidAmount:N2} {GetCurrencySymbol()}";
        public string FormattedRemainingAmount => $"{(TotalAmount - PaidAmount):N2} {GetCurrencySymbol()}";
